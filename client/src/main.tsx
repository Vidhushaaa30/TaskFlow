...
/**
 * Setup React client application scaffolding with Vite
 * Category: COMPONENT
...
export const main: React.FC<mainProps> = ({
  ...
  const handleExecute = () => {
    ...
    setTimeout(() => {
      setStatus('ready');
      if (onAction) {
        onAction({ action: 'execute', module: 'main', value: inputValue });
      }
    }, 300);
  };
  ...
  return (
    <div className={`p-5 rounded-xl border border-zinc-800 bg-zinc-900/60 backdrop-blur-md shadow-lg ${className}`}>
      ...
      <p className="text-xs text-zinc-400 mb-4 leading-relaxed">
        Configure Vite build tool, React root and HTML entry container.
      </p>
